...
function MusicSection() {
    const tracks = [
        {
            name: "MaTsaDe",
            desc: "Chaos and a little bit of anger mixed with super-speed and irritation, But also, melancholy and discreetness as a cherry on top.",
            links: {
        ...
        },
        {
            ...
            desc: "Chaos and a little bit of anger mixed with super-speed and irritation, But also, melancholy and discreetness as a cherry on top.",
            links: {
                spotify: "https://open.spotify.com/track/5zyXXd6QcE8Ckpe67xZgRC?si=8cfba99ef9f24cbd",
                imusic: "https://music.apple.com/us/album/hammock/1768921679?i=1768921680",
                youtube: "https://youtu.be/v3lm5bROYSI?si=s2k-YRwWkUleeeuh",
                soundcloud: "https://soundcloud.com/akipshidze/hammock",
                bandcamp: "https://akipshidze.bandcamp.com/track/hammock",
            },
            image: {
                big: "/img/music/tracks/Hammock.jpg",
                small: "/img/music/tracks/Hammock_small.jpg",
                name: "Hammock",
            },
        },
    ]
  return (
    <div className='section-music'>
        ...
        <div className='section-music-tiles'>
            {tracks.map(track => {
                return <TrackTile nameTrack={track.name} descTrack={track.desc} linksTrack={track.links} imageTrack={track.image}/>;
            })}
        </div>
