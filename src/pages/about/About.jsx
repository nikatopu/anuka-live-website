      ...
      <div className='sections-about'>
        ...
        <div className='about-me'>
          <div className='about-me-left'>
            ...
            <img src="/img/pages/home/about/family.webp" alt="Anuka Kipshidze's family"/>
          </div>
          <div className='about-me-right'>
            <img src="/img/pages/home/about/AnukaAsAChild.webp" alt="Anuka Kipshidze as a child"/>
          </div>
        </div>
        ...
        <div className='text-and-photos'>
          ...
          <div className='photos'>
            <img src="/img/pages/home/about/AnukaNewcommers.webp" alt="Anuka Kipshidze at Newcommers"/>
          </div>
        </div>
        <div className='text-and-photos'>
          <div className='text'>
          ...
          <div className='photos photos-many'>
            <img src="/img/pages/home/about/AnukaWorking.webp" alt="Anuka Kipshidze working"/>
            <img src="/img/pages/home/about/AnukaLooking.webp" alt="Anuka Kipshidze looking at the camera"/>
          </div>
        </div>
        <div className='mid-section'>
          <h4>
